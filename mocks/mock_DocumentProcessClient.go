...
// Source: doc-translate-go/gen/go/proto/documentprocessor (interfaces: DocumentProcessorClient)
//
...
import (
	context "context"
	documentprocessor "doc-translate-go/gen/go/proto/documentprocessor"
	reflect "reflect"
...
func (m *MockDocumentProcessorClient) ProcessDocument(arg0 context.Context, arg1 *documentprocessor.DocumentRequest, arg2 ...grpc.CallOption) (*documentprocessor.DocumentResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*documentprocessor.DocumentResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
